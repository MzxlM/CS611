...
public class Constant {
    ...
    public static final int NEXUS = 1;
    ...
    //only one team allowed on this game
    public static final int GAMER_NUMBER_FOR_VALOR = 1;
    ...
    public static final int LANE_SIZE = 2;
    public static final int INPUT_NUMBER_PRINT_HERO = -101;

    //Nexus type
    public static final String HERO_NEXUS = "hero";
    public static final String MONSTER_NEXUS = "monster";
    public static final int MONSTER_NEXUS_COORDINATE = 0;
    public static final int HERO_NEXUS_COORDINATE = 7;
    ...
    public static final String[] HERO_ACTIONS_INSCTRUCTIONS = { "Move", "Teleport", "Back", "Inventories check", "Attack","Cast spell"};
